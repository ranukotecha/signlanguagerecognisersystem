...
with mp_hands.Hands(
    ...
    while cap.isOpened():
        ...
        if(len(sentence) > 0): 
            cv2.putText(frame,"Output: -"+' '.join(mapping[sentence[0]])+''.join(accuracy), (4,30), 
...
# Main body of code
        ...
        # Remember that your sentences can only be 16 characters long!
               # print("Writing to display")
                  display.lcd_display_string(mapping[sentence[0]], 1)  # Write line of text to first line of display
  ...
  #  print("Cleaning up!")
             ...
             cv2.putText(frame,"Output: -"+' '.join(accuracy), (4,30), 
                         cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
        # print("---", sentence, "-----")
        # cv2.putText(frame,"Output: -"+' '.join(sentence)+''.join(accuracy), (4,30), 
        #                cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
